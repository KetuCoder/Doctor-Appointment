  ...
  return dashData && (
    <div className='mt-5'>
        <div className='flex flex-wrap gap-3'>
          ...
          <div className='ml-6 flex items-center gap-2 bg-white p-4 min-w-52 rounded border-2 border-gray-100 cursor-pointer hover:scale-105 transition-all'>
              ...
              dashData.latestAppointments.map((item,index)=>(
                <div className="flex items-center px-6 py-3 gap-3 hover:bg-gray-100" key={index}>
                  ...
                  </div>
                  {
                    ...
                    <img onClick={()=>AppointmentCancel(item._id)} src={assets.cancel_icon} className="w-10 cursor-pointer" alt="" /> 
                  }
                </div>
              ))
            }
